...
ecma_value_t ecma_builtin_object_object_entries (ecma_object_t *obj_p);
...
ecma_value_t ecma_builtin_object_object_get_own_property_descriptors (ecma_object_t *obj_p);
